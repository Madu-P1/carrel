...
- **Flashcards focus campaign:** plan in `docs/plans/flashcards-focus-2026-05-09.md`. PRs 1–3 + 7 shipped; PR 4 (citation reveal on the SRS back face, deep-linking to the source chunk) shipped 2026-05-12. Remaining: PR 5 (cloze + reverse cards) and PR 6 (session pacing).
