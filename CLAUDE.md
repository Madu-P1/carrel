...
- **Native shell:** Swift + SwiftPM, macOS 14+. `macos-app/Sources/EinsteinDesktopApp/`. WKWebView loads a bundled HTML app.
...
| `macos-app/Resources/` | Bundled HTML (`app.new.html`) |
...
- **Single frontend.** The Preact + TypeScript + Vite app is the only shipped bundle. The 310KB `app.html.legacy` escape hatch was retired in commit d1ba6a80.
...
- Swift-side menu dispatch lacks formal XCTest coverage.
