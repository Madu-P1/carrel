...
- **Flashcards focus campaign:** plan in `docs/plans/flashcards-focus-2026-05-09.md`. PRs 1–3 + 7 shipped; PR 4 (citation reveal on the SRS back face, deep-linking to the source chunk) shipped 2026-05-12; PR 5.1 (cloze deletion cards, ADR 0002) and PR 5.2 (reverse-pair cards, ADR 0003) shipped 2026-05-13. PR 6 (session pacing) partially shipped: 6.1, 6.3, 6.4 in commits 87f7e867 / b3f7deda+e08d302f+66da9d7d / 5993a248. Remaining: PR 6.2 (check the plan for residuals).
