...
The shipped date/duration detector (``cachet_verify/detectors/date_duration_conflict.py``)
...
``cachet_verify.detectors.date_duration_conflict`` (``_parse_date``, ``_DATE_SRC``,
...
input, same output list, always.
    ...
    from cachet_verify.detectors.temporal_graph import detect_temporal_contradictions
...
from .date_duration_conflict import (
    _DATE_SRC,
    _parse_date,
    _run_in_source,
    _spelled_value,
