...
from ``cachet_verify.detectors.date_duration_conflict`` (``_normalize``, ``_run_in_source``);
...
input, same output list, always.
    ...
    from cachet_verify.detectors.crossref_integrity import check_crossref_integrity, detect
...
from .date_duration_conflict import _normalize, _run_in_source
