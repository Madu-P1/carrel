...
| `reset_default_provider()` | [ai/providers.py:410-417](../../ai/providers.py) | **Tests must call this in setUp and tearDown when mutating provider env vars.** Pattern: see [tests/test_tutor_grounded.py:534-587](../../tests/test_tutor_grounded.py) `test_pro_tutor_fails_closed_on_null_provider`. |
