...
2. **Per-card timing telemetry** — **SHIPPED 2026-05-10** (commit `2f9e248d`). Records `seconds_to_first_reveal` and `seconds_to_rate` on every review event. Don't display yet; this is data for future tuning of FSRS parameters.
