...
CASES: list[Case] = [
    ...
    Case(
        ...
        note="physical-unit figure (tons) is NOT an anchored type: blind spot, must refuse",
    ),
    ...
    Case(
        ...
        note="drug dosage (mg) is NOT an anchored type: the highest-stakes blind spot, must refuse",
    ),
    Case(
        id="M2",
        domain="medical",
    ...
    Case(
        ...
        note="bare grouped count is NOT an anchored type: blind spot, must refuse",
    ),
