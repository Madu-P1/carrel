...
export function BrandMark() {
  ...
  if (showFallback) {
    return (
      <div className={styles.fallback} aria-label="Einstein Tutor">
  ...
  return (
    <img
      ...
      onLoad={(event) => {
        ...
        // fails when the real logo hasn't been dropped in yet. Detect the
        // placeholder at runtime by its intrinsic dimensions and swap to
        // the text monogram — keeps the topbar looking intentional during
        // development instead of showing a blank navy tile.
