 ...
 *
 * Phase 2 hooks (not implemented):
 *   - "Open in Calendar.app" deep-link via `webcal://` or
 *     `x-apple-calendar://event/<id>` (needs the Apple Calendar
 *     event identifier carried through the EventKit bridge — today
 *     we only carry the external UID).
 *   - "Insert study session before this" — would prefill a
 *     suggestion anchored to this event's start_at minus N hours.
 *   - Decline / accept tentative events — needs write-side EventKit
